          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-display text-foreground mb-6">
                Bath<span className="font-light">Concept</span>
              </h2>
              <p className="text-body text-text-secondary leading-relaxed mb-8">
                Experience the perfect harmony between natural materials and contemporary design. 
              ...
              <p className="text-body text-text-secondary leading-relaxed">
                From locally sourced marble to handcrafted fixtures, each element is carefully 
                selected to create spaces that breathe with natural beauty and timeless sophistication.
              </p>
            </div>
